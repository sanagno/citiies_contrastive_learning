...
def main(args):
    ...
    dataset = CustomDatasetFromImagesTemporal(train_csv,
    ...
    if args.rank == 0:
        torch.save(model.module.backbone.state_dict(), args.exp_dir / "resnet50_fmow.pth")


def adjust_learning_rate(args, optimizer, loader, step):
    max_steps = args.epochs * len(loader)
    warmup_steps = 10 * len(loader) 
    base_lr = args.base_lr * args.batch_size * 8 / 1024
